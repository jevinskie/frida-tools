all: frida_tools/fs_agent.js frida_tools/tracer_agent.js frida_tools/itracer_agent.js frida_tools/report_exceptions_agent.js
...
frida_tools/report_exceptions_agent.js: agents/report-exceptions/agent.ts
	cd agents/report-exceptions && npm install && npm run build
